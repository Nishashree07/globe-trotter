        ...
        <div className="hidden lg:block">
          <div className="bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-3xl p-12 text-white shadow-2xl">
            ...
            <p className="text-xl mb-8 text-emerald-100">
              Sign in to access your bookings, manage your trips, and discover amazing destinations around the world.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold">Explore 100+ Destinations</h3>
                  <p className="text-emerald-200">Discover amazing places worldwide</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold">Book Flights & Hotels</h3>
                  <p className="text-emerald-200">Best deals on travel</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold">Manage Your Trips</h3>
                  <p className="text-emerald-200">All your bookings in one place</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pl-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-gray-900"
                  required
                />
