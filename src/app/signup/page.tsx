    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-50 flex items-center justify-center px-4">
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block">
          <div className="bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-3xl p-12 text-white shadow-2xl">
            ...
            <p className="text-xl mb-8 text-emerald-100">
              Join thousands of travelers exploring the world with exclusive deals and personalized experiences.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold">Exclusive Member Deals</h3>
                  <p className="text-emerald-200">Save up to 30% on bookings</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-emerald-200">Earn points on every trip</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-emerald-200">AI-powered travel suggestions</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="John"
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-gray-900"
                  required
                />
              </div>
              <div>
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center">
                ...
                />
                <span className="ml-2 text-sm text-gray-600">
                  Send me exclusive deals and travel tips via email
                </span>
              </label>
            </div>
